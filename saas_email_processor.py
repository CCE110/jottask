...
{{
    ...
    "actions": [
        {{
            ...
            "title": "[Customer FULL NAME] - [specific action verb + what]",
...
Rules:
- CRITICAL: Task titles MUST always include the customer's FULL NAME (first + last) and a SPECIFIC action. Never use generic titles like "Follow up with Paul" — always "Paul Thompson - follow up on battery quote" or "Paul Van Zijl - call at 8am re solar battery referral"
...
Rules:
- CRITICAL: Task titles MUST always include the customer's FULL NAME (first + last) and a SPECIFIC action. Never use vague titles like "Follow up with Paul" or "Prepare for site visit". Always use format: "Paul Thompson - follow up on battery quote" or "Todd McHenry - site visit 8am Black Milk"
