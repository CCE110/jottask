...
class AIEmailProcessor:
    ...
    def process_forwarded_emails(self):
        ...
        try:
            ...
            processed_count = 0
            for msg_id in reversed(email_ids[-20:]):  # Process newest 20 first
    ...
    def _load_processed_emails(self):
        """Load set of already-processed email Message-IDs from Supabase"""
        try:
            ...
            print(f"📊 Loaded {len(ids)} processed emails")
            return ids
        except Exception as e:
