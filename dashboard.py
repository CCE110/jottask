...
def save_action():
    ...
    try:
        ...
        if submit_action == 'save_approve':
            # Create task from edited data and mark approved
            ...
            if action_type == 'update_crm':
                ...
                task_data['category'] = 'calendar'
                task_data['due_date'] = existing_action.get('due_date')
            elif action_type == 'change_deal_status':
                task_data['category'] = 'deals'
            if existing_action.get('due_date'):
                task_data['due_date'] = existing_action['due_date']
